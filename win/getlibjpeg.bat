...
if not exist %key%-source git clone https://github.com/LuaDist/libjpeg.git "%_buildroot_%/%key%-source"
...
cmake -DZLIB_LIBRARY=%_buildroot_%/libz-source/zlib.lib -DZLIB_INCLUDE_DIR=%_buildroot_%/libz-source -S . -B build -A x64 -DCMAKE_GENERATOR_TOOLSET=host=x64
